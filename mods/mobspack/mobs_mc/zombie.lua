...
--baby_zombie.collisionbox = {-0.25, -1, -0.3, 0.25, 0.75, 0.3}
...
-- Spawning
--[[
	name, nodes, neighbors, 
	min_light, max_light, interval,chance, active_object_count, 
	min_height, max_height, day_toggle, on_spawn

	mobs:spawn_specific("mobs_mc:cow", mobs_mc.spawn.grassland, {"air"}, 
	9, minetest.LIGHT_MAX+1, 30, 17000, 20, 
	mobs_mc.spawn_height.overworld_min, mobs_mc.spawn_height.overworld_max)]]--
	
--[[
mobs:spawn_specific("mobs_mc:zombie", mobs_mc.spawn.solid, {"air"}, 
	0, 7, 30, 6000, 4, 
	mobs_mc.spawn_height.overworld_min, mobs_mc.spawn_height.overworld_max)
	]]--
mobs:spawn_specific("mobs_mc:zombie", mobs_mc.spawn.solid, {"air"}, 
...
mobs:spawn_specific("mobs_mc:baby_zombie", mobs_mc.spawn.solid, {"air"}, 0, 5, 30, 60000, 4, mobs_mc.spawn_height.overworld_min, mobs_mc.spawn_height.overworld_max)
...
mobs:spawn_specific("mobs_mc:husk", mobs_mc.spawn.desert, {"air"}, 0, 5, 30, 6500, 4, mobs_mc.spawn_height.overworld_min, mobs_mc.spawn_height.overworld_max)
...
mobs:spawn_specific("mobs_mc:baby_husk", mobs_mc.spawn.desert, {"air"}, 0, 5, 30, 65000, 4, mobs_mc.spawn_height.overworld_min, mobs_mc.spawn_height.overworld_max)

...
mobs:register_mob("mobs_mc:creeper", {
	...
	-- Added to make crepers less greedy [SCH]
	--visual_size = {x=3, y=3},
	visual_size = {x=2, y=2},
	sounds = {
		attack = "tnt_ignite",
	...
	-- Modified to make crepers less greedy [SCH].May be changed to 2
	--explosion_radius = 3,
	explosion_radius = 1,
...
-- Modified to make crepers less greedy [SCH].
...
mobs:spawn_specific("mobs_mc:creeper", mobs_mc.spawn.solid, {"air"}, 0, 7, 20, 66500, 2, mobs_mc.spawn_height.overworld_min, mobs_mc.spawn_height.overworld_max)
